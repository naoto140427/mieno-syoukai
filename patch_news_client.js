...
const insertAfter = "export default function NewsDetailClient({ news }: NewsDetailClientProps) {";
const toInsert = `
...
content = content.replace(insertAfter, insertAfter + toInsert);

const endDivIndex = content.indexOf('<div className="mt-24 pt-8 border-t border-white/10 text-center flex flex-col items-center">');
...
content = content.slice(0, endDivIndex) + renderSurvey + '\n' + content.slice(endDivIndex);
